...
CREATE TABLE `detallecompras` (
  ...
  CONSTRAINT `detallecompras_ibfk_1` FOREIGN KEY (`IdCompra`) REFERENCES `compras` (`IdCompra`),
  CONSTRAINT `detallecompras_ibfk_2` FOREIGN KEY (`IdProducto`) REFERENCES `productos` (`IdProducto`)
